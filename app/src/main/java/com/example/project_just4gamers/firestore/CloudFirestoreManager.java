...
import com.example.project_just4gamers.userInterface.activities.ActivateCouponActivity;
import com.example.project_just4gamers.userInterface.activities.AddAddressActivity;
import com.example.project_just4gamers.userInterface.activities.AddMessageActivity;
import com.example.project_just4gamers.userInterface.activities.AddProductActivity;
import com.example.project_just4gamers.userInterface.activities.AddReviewActivity;
import com.example.project_just4gamers.userInterface.activities.AddressListActivity;
import com.example.project_just4gamers.userInterface.activities.CartListActivity;
import com.example.project_just4gamers.userInterface.activities.CheckoutActivity;
import com.example.project_just4gamers.userInterface.activities.DashboardActivity;
import com.example.project_just4gamers.userInterface.activities.DiscountCouponsActivity;
import com.example.project_just4gamers.userInterface.activities.FavoritesActivity;
import com.example.project_just4gamers.userInterface.activities.LoginActivity;
...
import com.example.project_just4gamers.userInterface.activities.ProductOwnerProfileActivity;
import com.example.project_just4gamers.userInterface.activities.SettingsActivity;
import com.example.project_just4gamers.userInterface.activities.UpdateProductActivity;
import com.example.project_just4gamers.userInterface.activities.UserProfileActivity;
import com.example.project_just4gamers.models.User;
import com.example.project_just4gamers.userInterface.fragments.DashboardFragment;
import com.example.project_just4gamers.userInterface.fragments.OrdersFragment;
import com.example.project_just4gamers.userInterface.fragments.ProductsFragment;
import com.example.project_just4gamers.userInterface.fragments.ReceivedMessagesFragment;
import com.example.project_just4gamers.userInterface.fragments.SentMessagesFragment;
import com.example.project_just4gamers.userInterface.fragments.SoldProductsFragment;
...
public class CloudFirestoreManager {
    ...
    public void deleteProduct(ProductsFragment fragment, String productID){
        fStore.collection(Constants.getPRODUCTS())
            ...
            public void onFailure(@NonNull Exception e) {
                //hide progress dialog
                System.out.println("Eroare stergere produs");
            }
        });
    }
