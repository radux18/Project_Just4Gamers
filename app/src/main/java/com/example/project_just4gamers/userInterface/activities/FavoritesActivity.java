...
import com.example.project_just4gamers.userInterface.adapters.FavoriteProductsListAdapter;
...
public class FavoritesActivity extends AppCompatActivity {
    ...
    private void getFavoriteProduct() {
        new CloudFirestoreManager().getFavoriteProducts(FavoritesActivity.this);
    }
