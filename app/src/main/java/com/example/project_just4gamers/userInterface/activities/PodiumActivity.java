...
import com.example.project_just4gamers.userInterface.adapters.PodiumListAdapter;
import com.example.project_just4gamers.userInterface.adapters.PodiumListAdapterV2;
import com.example.project_just4gamers.userInterface.adapters.PodiumListAdapterV3;
...
public class PodiumActivity extends AppCompatActivity {
    ...
    private void getAllUserV3() {
        new CloudFirestoreManager().getAllUsersV3(PodiumActivity.this);
    }

    private void getAllUserV2() {
        new CloudFirestoreManager().getAllUsersV2(PodiumActivity.this);
    }


    private void getAllUser() {
        new CloudFirestoreManager().getAllUsers(PodiumActivity.this);
    }
