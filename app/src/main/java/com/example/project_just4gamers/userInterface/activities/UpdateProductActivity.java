...
public class UpdateProductActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (validate()){
                    if (selectedImageFileURI != null){
                        new CloudFirestoreManager().uploadImageToCloudStorage(UpdateProductActivity.this,selectedImageFileURI, Constants.getProductImage());
                    } else {
                        updateProduct();
                    }
                }
    ...
    private void updateProduct() {
        ...
        new CloudFirestoreManager().updateProduct(UpdateProductActivity.this, productHashMap, productDetails.getProduct_id());
    }
    ...
    private void populateUI(Product productDetails) {
        ...
        if (productDetails.getType().equals(Constants.getNEW())){
