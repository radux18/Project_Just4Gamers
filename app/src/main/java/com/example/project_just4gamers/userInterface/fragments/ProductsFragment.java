...
import com.example.project_just4gamers.userInterface.adapters.ProductListAdapter;
...
public class ProductsFragment extends Fragment {
    ...
    private void showAlertDialogDeleteProduct(String productID){
        ...
        builder.setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new CloudFirestoreManager().deleteProduct(ProductsFragment.this, productID);
                dialog.dismiss();
            }
        });
    ...
    private void getProductListFromFirestore(){
        //show progress dialog
        new CloudFirestoreManager().getProductList(ProductsFragment.this);
    }
